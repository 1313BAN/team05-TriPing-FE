<template>
  <transition name="slide-up">
    <div
      v-if="visible"
      class="absolute bottom-0 left-0 w-full z-[9999] bg-white rounded-t-2xl h-[300px] flex flex-col justify-around items-center shadow-[0_-4px_20px_rgba(0,0,0,0.2)]"
    >
      <h2 class="text-2xl font-bold text-center">{{ attractionTitle }} 안에 있어요</h2>

      <div class="flex flex-col w-full justify-around px-4 gap-3">
        <Button
          label="AI 가이드 확인하기"
